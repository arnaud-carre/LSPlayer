...
LSP_MusicFade:
			lea        LSP_State(pc),a1
			moveq.l    #0,d1
			move.b     m_chan4Vol(a1),d1
			mulu       d0,d1
			lsr.w      #6,d1
			move.b     d1,$d9-$a0(a6)
			move.b     m_chan3Vol(a1),d1
			mulu       d0,d1
			lsr.w      #6,d1
			move.b     d1,$c9-$a0(a6)
			move.b     m_chan2Vol(a1),d1
			mulu       d0,d1
			lsr.w      #6,d1
			move.b     d1,$b9-$a0(a6)
			move.b     m_chan1Vol(a1),d1
			mulu       d0,d1
			lsr.w      #6,d1
			move.b     d1,$a9-$a0(a6)
			rts
...
.cmdExec:	add.b	d0,d0
			bcc.s	.noVd
			move.b	(a0)+,d3
			move.b  d3,m_chan4Vol(a1)
			move.b  d3,$d9-$a0(a6)
.noVd:		add.b	d0,d0
			bcc.s	.noVc
			move.b	(a0)+,d3
			move.b  d3,m_chan3Vol(a1)
			move.b  d3,$c9-$a0(a6)
.noVc:		add.b	d0,d0
			bcc.s	.noVb
			move.b	(a0)+,d3
			move.b  d3,m_chan2Vol(a1)
			move.b  d3,$b9-$a0(a6)
.noVb:		add.b	d0,d0
			bcc.s	.noVa
			move.b	(a0)+,d3
			move.b  d3,m_chan1Vol(a1)
			move.b  d3,$a9-$a0(a6)
.noVa:		
